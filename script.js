...
const API_KEY ='e06ec8d0c59cf771d3a918b75bf43063';
...
function getApi(bdcApi) {
    ...
    Http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            countryEl.innerHTML= x.locality +","+x.principalSubdivision+","+x.countryCode;
        }
    };
}
...
function getWeatherData () {
    navigator.geolocation.getCurrentPosition((success) => {
        ...
        getApi(`https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${latitude}&longitude=${longitude}&localityLanguage=en`);
